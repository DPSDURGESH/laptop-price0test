...
dataframe = pd.read_csv(r'C:/Users/Lenovo/Pictures/laptop.csv')
def main():
    activities = ['Select', 'Preprocessed Data', 'Prediction', 'About']
    choices = st.sidebar.selectbox("Select choices" ,activities)
    df = pickle.load(open(r'C:/Users/Lenovo/Pictures/Laptop-Price-Prediction-main/Laptop-Price-Prediction-main/pickle file/processed_data.pickle','rb'))
    pipe = pickle.load(open(r'C:/Users/Lenovo/Pictures/Laptop-Price-Prediction-main/Laptop-Price-Prediction-main/pickle file/ml_model_pipe.pickle', 'rb'))
    if choices == 'Select':
